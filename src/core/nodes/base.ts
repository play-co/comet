...
import { getVisibleProperties } from '../util/typeUtil';
...
export class BaseNode extends EventEmitter<'get' | 'set'>
{
    ...
    public clone<T extends BaseNode>(/** todo: props */): T
    {
        ...
        // todo: polyfill with https://www.npmjs.com/package/proxy-polyfill
