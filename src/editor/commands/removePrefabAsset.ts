...
export interface RemovePrefabAssetCommandParams
{
    nodeIds: string[];
}

export interface RemovePrefabAssetCommandReturn
{
    nodes: (FolderNode | TextureAssetNode)[];
}

export interface RemovePrefabAssetCommandCache
{
    modifyModelCommands: ModifyModelCommand<SpriteModel>[];
    removeChildCommands: RemoveChildCommand[];
}

export class RemovePrefabAssetCommand
    extends Command<RemovePrefabAssetCommandParams, RemovePrefabAssetCommandReturn, RemovePrefabAssetCommandCache>
{
    public static commandName = 'RemovePrefabAsset';

    public apply(): RemovePrefabAssetCommandReturn
    {
